...
const testimonials = [
  ...
  {
    name: "Pushpa Waydande",
    text: "Excellent hospital with highly professional doctor. I truly recommend you please do visit this hospital.Thanks for being there whenever we need.",
    rating: 5,
    date: "3 weeks ago"
  },
  {
...
export default function Reviews() {
  const googleReviewUrl = "https://www.google.com/search?q=Shree+Sai+Hospital+Dighi+Reviews#lrd=0x3bc2c70019488e0b:0x72729606776846f7,1,,,";
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16">
          <div className="max-w-2xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-blue-600 font-bold text-sm tracking-widest uppercase mb-3">Patient Feedback</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((review, idx) => (
            <motion.div
              ...
              className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm relative hover:shadow-md transition-shadow"
            >
